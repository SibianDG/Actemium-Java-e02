...
public class ContractTypeViewModel extends ViewModel {
    ...
    public Map<String, Object> getDetails() {
        ...
        details.put("Email", String.format("%b", contractType.isHasEmail()));
        details.put("Phone", String.format("%b",contractType.isHasPhone()));
        details.put("Application", String.format("%b",contractType.isHasApplication()));

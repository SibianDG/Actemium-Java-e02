...
public class PopulateDB {
    public void run(UserDaoJpa userDao) {
        ...
        userDao.insert(new Employee("Tech123", "Passwd123&", "Johan", "Van Schoor","Overwale 42","091354864","thomas.dirven@hogent.be", EmployeeRole.ADMINISTRATOR));
        ...
        userDao.insert(new Customer("cust01Barak", "Passwd123&", "Barak", "Obama", theWhiteHouse));
